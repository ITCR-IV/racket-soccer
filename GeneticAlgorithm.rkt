...
(define (mutationFunction playerList)
  (cond ((null? playerList) null)
        (else (cons (list (caar playerList) (cadar playerList)
                    (list (cond ((< 1000 (+ (car(caddar playerList)) (- (random 21) 10))) 1000)
                                ((> 0 (+ (car(caddar playerList)) (- (random 21) 10))) 0)
                                (else (+ (car(caddar playerList)) (- (random 21) 10))))
                          (cond ((< 650 (+ (cadr(caddar playerList)) (- (random 11) 5))) 650)
                                ((> 0 (+ (cadr(caddar playerList)) (- (random 11) 5))) 0)
                                (else (+ (cadr(caddar playerList)) (- (random 11) 5)))))
